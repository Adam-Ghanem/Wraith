...
CREATE TABLE evidence_observations (
    ...
    kind TEXT NOT NULL CHECK (kind IN ('http', 'technology', 'javascript', 'api_endpoint', 'client_side', 'fuzz', 'content_discovery', 'validation')),
...
INSERT INTO evidence_observations SELECT * FROM evidence_observations_r8;
