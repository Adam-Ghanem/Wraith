DROP INDEX IF EXISTS idx_evidence_observations_project_subject_time;

ALTER TABLE evidence_observations RENAME TO evidence_observations_r5;
...
FROM evidence_observations_r5;

DROP TABLE evidence_observations_r5;
