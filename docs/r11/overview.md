...
R11 is a sequential program. **R11.1, R11.2, and R11.3 are approved and implemented on separate feature branches.** R11.4 through R11.6 remain unstarted and require separate explicit approval.
