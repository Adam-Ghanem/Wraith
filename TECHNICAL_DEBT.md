...
| R13 concrete live adapter configuration | R13 defines scope snapshots, task ordering, budget-sharing executor, and plan CLI, but does not implicitly install live R4/R7/R11.3/R11.4 adapters. | Auto-wiring active modules without project scope/R3/R2/R10.5/R11 dependencies could bypass authorization or duplicate lifecycle ownership. | Add adapters only with explicit injected policy/transport/evidence controls, localhost E2E coverage, durable owner-owned lifecycle state, and independent security review. |
